...
addpath('../lib/DL_toolbox/util','../lib/DL_toolbox/NN','../lib/DL_toolbox/DBN','../lib/helper_functions');
...
% do nomalization and change data value to [0-1]
...
%% do auto-encoder
[ dbn ] = rbm( train_x );
[ new_feat, new_feat_test ] = newFeature_rbm( dbn,train_x,X_test );
